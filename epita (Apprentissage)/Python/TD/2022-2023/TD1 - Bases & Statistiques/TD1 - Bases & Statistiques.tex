...
\question{Calculez et affichez l'\textit{étendue} de la distribution en faisant la différence entre la valeur la plus élevée de la distribution à la valeur la plus petite.}
