...
\usepackage{MetalCours} % Appelle un .sty
...
%%% Course outline
\include{1-introduction/10-introduction.tex}

%%% Language, CLI, versions, ...
\include{2-discovering-python/20-discovering-python.tex}

%%% Hello world, print, str/int, Sys module
\include{3-small-scripts/30-small-scripts.tex}

%%% Declaring functions, imports, modules
\include{4-functions-imports-modules/40-functions-imports-modules.tex}

%%% Classes, Files, and Directories
\include{5-classes-files-others/50-classes-files-others.tex}

%%% Types, lists (comprehension, ...)
\include{6-main-concepts/60-main-concepts.tex}
