...
\hline
 & & & &  & & \\
$ \% \, 1010 \; 0100 \; 1010 $  & &   2634     & & &  -1462 & \\
 & & & &  & & \\
\hline
% & & & &  & & \\
%$ \% \, 1100 \; 0011 \; 0011 $  & &  3123     & & &  -973  & \\
% & & & &  & & \\
%\hline
 & & & &  & & \\
$ \% \, 1110 \; 1101 \; 1001 $  & &   3801     & & &  -295  & \\
 & & & &  & & \\
\hline
% & & & &  & & \\
%\$ BCD  & &                          3021     & & &  -1075  & \\
...
%\hline
 & & & &  & & \\
$ 2798 $  & &   1010 1110 1110  & & &  AEE  & \\
 & & & &  & & \\
\hline
 & & & &  & & \\
$ -100 $  & &   1111 1001 1100  & & &  F9C  & \\
 & & & &  & & \\
\end{tabular}
}
...
\subsection{(1 point) Convertissez ce nombre en flottant au format IEEE 754 simple précision : }
...
\hline
\multirow[c]{3}{*}[0in]{$ 34,328125 $}    & \multirow[c]{3}{*}[0in]{$ \% $} & & & & & & & &  & \multirow[c]{3}{*}[0in]{$ \$ $} & & & & & & & & \\
                                          & & 1 & 0 & 0 & 0 & 0 & 1 & 0 & 0                  & & 4 & 2 & 0 & 9 & 5 & 0 & 0 & 0 \\
                                          & & & & & & & & &                                  & & & & & & & & & \\
%\hline
%\multirow[c]{3}{*}[0in]{$ -235,6328125 $} & \multirow[c]{3}{*}[0in]{$ \% $} & & & & & & & &  & \multirow[c]{3}{*}[0in]{$ \$ $} & & & & & & & & \\
%                                          & & 1 & 0 & 0 & 0 & 0 & 1 & 1 & 0                  & & C & 3 & 6 & B & A & 2 & 0 & 0 \\
%                                          & & & & & & & & &                                  & & & & & & & & & \\
\hline
\end{tabular}
}
...
\centering{
\includegraphics[scale=0.42]{img/Tab_1_Sujet_2_underlined.png}
}
...
\cline{2-13}
                              ...
                              &          53 & 20 & 54 & 58 & 54 & \cellcolor{black!15} &  53 & 20 & 20 & 20 & 20 & \cellcolor{black!15} \\
\hline
...
\multirow[c]{3}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 02 01 } & \multicolumn{6}{c|}{ 05 01 } \\
                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{3}{*}[0in]{size} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 1F 00 00 00 } & \multicolumn{6}{c|}{ 00 00 00 00 } \\
                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
\end{tabular}
...
\hline
 ...
 & & & & \\
\hline
\multirow[c]{3}{*}[0in]{direntry[0] (f1)} &  1F 00 00 00 $\rightarrow$ 00 00 00 1F  &  02 01 $\longrightarrow$ 01 02  &  $ \Box $ Read Only    & $ \Box $ Hidden \\ % \checkmark
                                          &                                         &                                 &  $ \Box $ Volume ID    & $ \Box $ System \\
                                          &  31                                     &  258                            &  $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[1] (f2)} &  00 00 00 00 $\rightarrow$ 00 00 00 00  &  05 01 $\longrightarrow$ 01 05  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                          &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                          &  0                                      &  261                            & \text{\sffamily X} Directory    & $ \Box $ Archive \\
\hline
\end{tabular}
}
\end{center}
...
\centering{
\includegraphics[scale=0.42]{img/Tab_2_Sujet_2_underlined.png}
}
...
\multirow[c]{2}{*}[0in]{name} &           2E & 20 & 20 & 20 & 20 & 20     & 2E & 2E & 20 & 20 & 20 & 20 \\
%                              &             & & & & &            &   & & & & & \\
\cline{2-13}
%                              &             & & & & &            &   & & & & & \\
                              &           20 & 20 & 54 & 58 & 54 & \cellcolor{black!15} & 20 & 20 & 54 & 58 & 54 & \cellcolor{black!15} \\
\hline

\multirow[c]{2}{*}[0in]{attributes} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 10 } & \multicolumn{6}{c|}{ 10 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{2}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 05 01 } & \multicolumn{6}{c|}{ 00 00 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{2}{*}[0in]{size} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 00 00 00 00 } & \multicolumn{6}{c|}{ 00 00 00 00 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
\end{tabular}
...
\multirow[c]{2}{*}[0in]{name} &           4E & 31 & 20 & 20 & 20 & 20     & 4E & 32 & 20 & 20 & 20 & 20 \\
%                              &             & & & & &            &   & & & & & \\
\cline{2-13}
%                              &             & & & & &            &   & & & & & \\
                              &           20 & 20 & 20 & 20 & 20 & \cellcolor{black!15} & 20 & 20 & 20 & 20 & 20 & \cellcolor{black!15} \\
\hline

\multirow[c]{2}{*}[0in]{attributes} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 20 } & \multicolumn{6}{c|}{ 20 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{2}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 07 01 } & \multicolumn{6}{c|}{ 08 01 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{2}{*}[0in]{size} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 0A 00 00 00 } & \multicolumn{6}{c|}{ 0C 00 00 00 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
\end{tabular}
...
\hline
 ...
 & & & & \\
\hline
\multirow[c]{3}{*}[0in]{direntry[0] (f11)} &  00 00 00 00 $\rightarrow$ 00 00 00 00  &  05 01 $\longrightarrow$ 01 05  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  0                                      &  261                            & \text{\sffamily X} Directory    & $ \Box $ Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[1] (f12)} &  00 00 00 00 $\rightarrow$ 00 00 00 00  &  00 00 $\longrightarrow$ 00 00  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  0                                      &  0                              & \text{\sffamily X} Directory    & $ \Box $ Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[2] (f13)} &  0A 00 00 00 $\rightarrow$ 00 00 00 0A  &  07 01 $\longrightarrow$ 01 07  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  10                                     &  263                            & $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[3] (f14)} &  0C 00 00 00 $\rightarrow$ 00 00 00 0C  &  08 01 $\longrightarrow$ 01 08  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  12                                     &  264                            & $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\end{tabular}
}
