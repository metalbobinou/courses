...
\multirow[c]{3}{*}[0in]{$ 68,78125 $}     & \multirow[c]{3}{*}[0in]{$ \% $} & & & & & & & &  & \multirow[c]{3}{*}[0in]{$ \$ $} & & & & & & & & \\
                                          & & 1 & 0 & 0 & 0 & 0 & 1 & 0 & 1                  & & 4 & 2 & 8 & 9 & 9 & 0 & 0 & 0 \\
                                          & & & & & & & & &                                  & & & & & & & & & \\
%\hline
%\multirow[c]{3}{*}[0in]{$ -218,3203125 $} & \multirow[c]{3}{*}[0in]{$ \% $} & & & & & & & &  & \multirow[c]{3}{*}[0in]{$ \$ $} & & & & & & & & \\
%                                          & & 1 & 0 & 0 & 0 & 0 & 1 & 1 & 0                  & & C & 3 & 5 & A & 5 & 2 & 0 & 0 \\
%                                          & & & & & & & & &                                  & & & & & & & & & \\
\hline
\end{tabular}
}
...
\centering{
\includegraphics[scale=0.42]{img/Tab_1_Sujet_1_underlined.png}
}
...
\cline{2-13}
                              ...
                              &          20 & 20 & 54 & 58 & 54 & \cellcolor{black!15} &  45 & 53 & 20 & 20 & 20 & \cellcolor{black!15} \\
\hline
...
\multirow[c]{3}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 03 01 } & \multicolumn{6}{c|}{ 04 02 } \\
                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
...
\hline
 ...
 & & & & \\
\hline
\multirow[c]{3}{*}[0in]{direntry[0] (f1)} &  1F 00 00 00 $\rightarrow$ 00 00 00 1F  &  03 01 $\longrightarrow$ 01 03  &  $ \Box $ Read Only    & $ \Box $ Hidden \\ % \checkmark
                                          &                                         &                                 &  $ \Box $ Volume ID    & $ \Box $ System \\
                                          &  31                                     &  259                            &  $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[1] (f2)} &  00 00 00 00 $\rightarrow$ 00 00 00 00  &  04 02 $\longrightarrow$ 02 04  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                          &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                          &  0                                      &  516                            & \text{\sffamily X} Directory    & $ \Box $ Archive \\
\hline
\end{tabular}
}
\end{center}
...
\centering{
\includegraphics[scale=0.42]{img/Tab_2_Sujet_1_underlined.png}
}
...
\multirow[c]{2}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 04 02 } & \multicolumn{6}{c|}{ 00 00 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
...
\multirow[c]{2}{*}[0in]{name} &           4D & 31 & 20 & 20 & 20 & 20     & 4D & 32 & 20 & 20 & 20 & 20 \\
%                              &             & & & & &            &   & & & & & \\
\cline{2-13}
%                              &             & & & & &            &   & & & & & \\
...
\multirow[c]{2}{*}[0in]{first\_cluster} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 05 02 } & \multicolumn{6}{c|}{ 06 02 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{2}{*}[0in]{size} & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c|}{ 0C 00 00 00 } & \multicolumn{6}{c|}{ 0A 00 00 00 } \\
%                              & \multicolumn{6}{c|}{ } & \multicolumn{6}{c|}{ } \\
\hline
\end{tabular}
...
\hline
 ...
 & & & & \\
\hline
\multirow[c]{3}{*}[0in]{direntry[0] (f11)} &  00 00 00 00 $\rightarrow$ 00 00 00 00  &  04 02 $\longrightarrow$ 02 04  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  0                                      &  516                            & \text{\sffamily X} Directory    & $ \Box $ Archive \\
\hline
...
\hline
\multirow[c]{3}{*}[0in]{direntry[2] (f13)} &  0C 00 00 00 $\rightarrow$ 00 00 00 0C  &  05 02 $\longrightarrow$ 02 05  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  12                                     &  517                            & $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\multirow[c]{3}{*}[0in]{direntry[3] (f14)} &  0A 00 00 00 $\rightarrow$ 00 00 00 0A  &  06 02 $\longrightarrow$ 02 06  & $ \Box $ Read Only    & $ \Box $ Hidden \\
                                           &                                         &                                 & $ \Box $ Volume ID    & $ \Box $ System \\
                                           &  10                                     &  518                            & $ \Box $ Directory    & \text{\sffamily X} Archive \\
\hline
\end{tabular}
}
