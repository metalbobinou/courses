...
\newcommand{\TypeExam}{Rattrapage CORRECTION}
...
\multirow{2}{*}{$ 1592 $} & \cellcolor{black!45} &
  ...
  \multirow{2}{*}{\$}   & & & \\
 & \cellcolor{black!45} & & 0 & 1 & 1 & 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 1 & \cellcolor{black!15} 1 & 1 & 0 & 0 & 0  & \cellcolor{black!45} & & 6 & 3 & 8 \\
\hline
\multirow{2}{*}{$ -654 $} & \cellcolor{black!45} &
  \multirow{2}{*}{\%} & & & & & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} & & & &  & \cellcolor{black!45} &
  \multirow{2}{*}{\$}   & & & \\
 & \cellcolor{black!45} & & 1 & 1 & 0 & 1 & \cellcolor{black!15} 0 & \cellcolor{black!15} 1 & \cellcolor{black!15} 1 & \cellcolor{black!15} 1 & 0 & 0 & 1 & 0  & \cellcolor{black!45} & & D & 7 & 2 \\
\hline
\end{tabular}
}
...
\multirow[c]{4}{*}[0in]{ \Large \TTBF{\$ 8076 AB2C} }  %% Denormalise
  ...
  &  & $ \Box $ $ - $ Zéro    & $ \Box $ $ - \infty $ \\
  & \multirow[c]{2}{*}[0in]{\textit{(0)}} & $ \checkmark $ Normalisé     & $ \Box $ Supranormalisé \\
...
\multirow[c]{2}{*}[0in]{$ 17,625 $}  & \cellcolor{black!15}
 ...
 & \cellcolor{black!15} 0
  & 1 & 0 & 0 & 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 1 & \cellcolor{black!15} 1 &
  & 4 & 1 & 8 & D & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 \\
\hline
\multirow[c]{2}{*}[0in]{$ -41,1875 $}  & \cellcolor{black!15}
  & & & & & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} &
  \multirow{2}{*}{\$} & & & & & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} & \cellcolor{black!15} \\
 & \cellcolor{black!15} 1
  & 1 & 0 & 0 & 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 1 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 &
  & C & 2 & 2 & 4 & \cellcolor{black!15} C & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 & \cellcolor{black!15} 0 \\
\hline
\end{tabular}
}
...
\multirow[c]{4}{*}[0in]{name} &  44 & 49 & 4E & 4F & 53 & 4F           &  47 & 41 & 53 & 4F & 4C & 49 \\
                              &     &    &    &    &    &              &     &    &    &    &    &    \\
\cline{2-13}
                              &  52 & 45 & 4A & 50 & 47 & \cellcolor{black!65} &  4E & 45 & 45 & 31 & 30 & \cellcolor{black!65} \\
...
\multirow[c]{3}{*}[0in]{first\_cluster} & \multicolumn{6}{c||}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c||}{00 64} & \multicolumn{6}{c|}{00 A3} \\
                              & \multicolumn{6}{c||}{ } & \multicolumn{6}{c|}{ } \\
\hline

\multirow[c]{3}{*}[0in]{size} & \multicolumn{6}{c||}{ } & \multicolumn{6}{c|}{ } \\
                              & \multicolumn{6}{c||}{00 00 11 BD} & \multicolumn{6}{c|}{00 00 07 95} \\
                              & \multicolumn{6}{c||}{ } & \multicolumn{6}{c|}{ } \\
\hline
\end{tabular}
...
%
%\begin{LARGE}
%\textbf{CORRECTION SUJET RATTRAPAGE}
%
%\bigskip
%
