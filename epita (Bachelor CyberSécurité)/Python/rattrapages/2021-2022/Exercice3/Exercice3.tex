...
\ExoSpecsSimple{\TTBF{my\_transpose.py}}{\TTBF{\RenduDir/src/my\_transpose.py}}{750}{640}
...
\noindent Vous devez écrire un script nommé \TTBF{my\_transpose.py} qui prendra en paramètre un fichier contenant une matrice, et affichera dans le terminal la version transposée.
