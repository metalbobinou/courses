...
%	\RenduSpecsGenerales{[CAV][TP1]}{1}{Pas de rendu}{\RenduDir}{\RenduTarball}{Pas de rendu}{Pas de rendu}
	\RenduSpecsGenerales{[RATT][PYTHON]}{1}{Devoir/Assignment sur Teams}{\RenduDir}{\RenduTarball}{27/06/2022 12h00}{2 semaines}
	& \\
%	\RenduSpecsTechniques{WAMP ou MAMP}{PHP}{Apache/PHP}{ }
	\RenduSpecsTechniques{Linux - Ubuntu (x86\_64)}{Python}{/usr/bin/python3.8}{ }
%	& \\
...
%\TTBF{\RenduDir/check/}\\
\TTBF{\RenduDir/src/}\\
\TTBF{\RenduDir/src/is\_even.py}\\
\TTBF{\RenduDir/src/my\_calc.py}\\
\TTBF{\RenduDir/src/my\_pintree.py}\\
\TTBF{\RenduDir/src/my\_transpose.py}\\
\end{tabular}
