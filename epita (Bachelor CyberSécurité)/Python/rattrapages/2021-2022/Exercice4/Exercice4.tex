...
\ExoSpecsSimple{\TTBF{my\_pintree.py}}{\TTBF{\RenduDir/src/my\_pintree.py}}{750}{640}
...
\noindent \TTBF{Usage:\textvisiblespace python\textvisiblespace my\_pintree.py\textvisiblespace number}
