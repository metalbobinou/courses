...
\newcommand{\TitreSeance}{Liste - Pile - File (tableaux)}
\newcommand{\SousTitreSeance}{TD5}
...
\newcommand{\DocKeywords}{Algorithmique ; Algorithmes ; Tableaux ; Liste ; Pile ; File ; API}
