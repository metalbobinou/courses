...
\newcommand{\TitreMatiere}{Systèmes - Windows \& Linux}
\newcommand{\DateExo}{18 janvier 2022}
\newcommand{\TypeExo}{TP}
\newcommand{\TitreExercice}{OS - Shell 2 (Fichiers)}
...
\newcommand{\RenduTarball}{login.x-TP2.tar.bz2}
\newcommand{\RenduDir}{login.x-TP2}
