...
\newcommand{\NumeroTD}{Définition, Insertions, Suppressions}
...
(2)
  ...
  \end{minipage}
\stepcounter{figure}
\caption{Fig.\thefigure : Suppression d'une feuille dans un ABR}
...
(2)
  ...
  \end{minipage}
\stepcounter{figure}
\caption{Fig.\thefigure : Suppression d'un point simple dans un ABR}
\label{fig:example3-BST-deletion-2-lone-child}
\end{table}
