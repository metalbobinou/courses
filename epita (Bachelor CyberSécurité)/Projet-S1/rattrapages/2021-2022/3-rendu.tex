...
%	\RenduSpecsGenerales{[CAV][TP1]}{1}{Pas de rendu}{\RenduDir}{\RenduTarball}{Pas de rendu}{Pas de rendu}
	\RenduSpecsGenerales{[RATT][PROJ-S1]}{1}{Devoir/Assignment sur Teams}{\RenduDir}{\RenduTarball}{27/06/2022 12h00}{2 semaines}
	& \\
%	\RenduSpecsTechniques{WAMP ou MAMP}{PHP}{Apache/PHP}{ }
	\RenduSpecsTechniques{Linux - Ubuntu (x86\_64)}{C et Python}{/usr/bin/gcc /usr/bin/python3.8}{-W -Wall -Werror -std=c99 -pedantic}
%	& \\
