...
%	\RenduSpecsGenerales{[RATT][C]}{1}{Devoir/Assignment sur Teams}{\RenduDir}{\RenduTarball}{23/04/2023 23h42}{3 semaines}
	\RenduSpecsGenerales{[RATT][C]}{1}{Devoir sur Moodle}{\RenduDir}{\RenduTarball}{14/05/2023 23h42}{2 semaines}
	& \\
...
\noindent Chaque fichier sera compilé indépendament, vous pouvez donc mettre un \TTBF{main} par fichier C.
