...
\newcommand{\TypeExo}{MiniProjet 2}
\newcommand{\TitreExercice}{Piles \& Files en tableaux}
...
\newcommand{\RenduTarball}{login.x-MiniProjet2.tar.bz2}
\newcommand{\RenduDir}{login.x-MiniProjet2}
