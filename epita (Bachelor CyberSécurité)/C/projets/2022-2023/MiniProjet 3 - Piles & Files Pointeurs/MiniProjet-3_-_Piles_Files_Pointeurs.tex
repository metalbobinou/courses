...
\newcommand{\DateExo}{15 janvier 2023}
\newcommand{\AnneeScolaire}{2022-2023}
\newcommand{\Organisation}{EPITA}
\newcommand{\TypeExo}{MiniProjet 3}
\newcommand{\TitreExercice}{Piles \& Files en pointeurs}
...
\newcommand{\RenduTarball}{login.x-MiniProjet3.tar.bz2}
\newcommand{\RenduDir}{login.x-MiniProjet3}
...
%% Exercice 1
\section{Exercice 1 - Pile avec liste chaînée}
