...
%\item[\checkmark]
\begin{itemize}
  \item[\checkmark] ((non (A > B)) et (non (B < A))) et ((B != A - 3) et (A == B - 3)) \\ % Vrai
  \item[\checkmark] (non ((A > B) ou (B < A))) et (non ((B == A - 3) et (A != B - 3))) \\ % Vrai
  \item[\checkmark] (non ((A > B) ou (B > A))) ou ((B != A - 3) et (A == B - 3)) \\ % Vrai
  \item[\checkmark] (non ((A >= B - 4) et (B >= A + 3))) ou ((B <= A + 3) ou (A <= B - 3)) \\ % Vrai
\end{itemize}
...
\begin{itemize}
  ...
  \item[\checkmark] Il est même récursif terminal \\ % Vrai
