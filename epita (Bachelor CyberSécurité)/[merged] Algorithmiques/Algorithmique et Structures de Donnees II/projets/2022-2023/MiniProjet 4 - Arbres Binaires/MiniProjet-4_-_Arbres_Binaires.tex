...
\newcommand{\TitreMatiere}{Algorithmique et Structure de Données II}
\newcommand{\DateExo}{03 mai 2023}
\newcommand{\AnneeScolaire}{2022-2023}
\newcommand{\Organisation}{EPITA}
\newcommand{\TypeExo}{MiniProjet 4}
\newcommand{\TitreExercice}{Arbres Binaires de Recherche}
\newcommand{\NomAuteurA}{Fabrice BOISSIER}
\newcommand{\MailAuteurA}{fabrice.boissier@epita.fr}
\newcommand{\NomAuteurB}{ }
\newcommand{\MailAuteurB}{ }
\newcommand{\VersionExo}{Version 1.3}
...
\newcommand{\RenduTarball}{login.x-MiniProjet4.tar.bz2}
\newcommand{\RenduDir}{login.x-MiniProjet4}
