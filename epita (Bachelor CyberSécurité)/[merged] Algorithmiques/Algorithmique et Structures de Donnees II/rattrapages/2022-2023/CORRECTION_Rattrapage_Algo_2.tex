...
ordre préfixe : & X & A & O & P & T & A & E & G & U & U & E & L & G & E & M & S \\
ordre infixe :  & P & O & T & A & G & E & A & U & X & L & E & G & U & M & E & S \\
ordre suffixe : & P & T & O & G & E & U & A & A & L & G & E & M & S & E & U & X \\
\end{tabular}
}
...
\centerline{
\begin{tabular}{L{2.5cm} C{0.5cm}C{0.5cm}C{0.5cm}C{0.5cm}C{0.5cm} C{0.5cm}C{0.5cm}C{0.5cm}C{0.5cm} C{0.5cm}C{0.5cm}C{0.5cm}C{0.5cm} C{0.5cm}C{0.5cm}C{0.5cm}}
ordre : & X & A & U & O & A & E & E & P & T & E & U & L & G & M & S & G \\
\end{tabular}
}
