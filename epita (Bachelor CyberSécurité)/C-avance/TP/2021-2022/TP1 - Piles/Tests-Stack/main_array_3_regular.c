...
void main_regular_tests(void)
{
  ...
  printf("Create 10 (2)\n");
  my_stack2 = stack_array_create(10);
  ...
  stack_array_pop(my_stack2);
  stack_array_pop(my_stack2);
  stack_array_push(2, my_stack2);
  stack_array_push(4, my_stack2);
  stack_array_push(8, my_stack2);
  stack_array_push(16, my_stack2);
  ...
  if (ret1 == 0)
    ...
    printf("!!! ERROR !!!\n");
  ret1 = stack_array_search(15, my_stack1);
  printf("Search 15 (1) 3 [2] : %d\n", ret1);
  if (ret1 == 2)
    printf("OK\n");
  else
    printf("!!! ERROR !!!\n");
  ret1 = stack_array_search(20, my_stack1);
  printf("Search 20 (1) 3 [-4] : %d\n", ret1);
  if (ret1 == -4)
    printf("OK\n");
  else
    printf("!!! ERROR !!!\n");
  ret1 = stack_array_search(42, my_stack1);
  printf("Search 42 (1) 3 [-4] : %d\n", ret1);
  if (ret1 == -4)
    printf("OK\n");
  else
    printf("!!! ERROR !!!\n");
  ret2 = stack_array_search(2, my_stack2);
  ...
  if (ret2 == 2)
    ...
    printf("!!! ERROR !!!\n");
  ret2 = stack_array_search(16, my_stack2);
  printf("Search 16 (2) 3 [-4] : %d\n", ret2);
  if (ret2 == -4)
    printf("OK\n");
  else
    printf("!!! ERROR !!!\n");
  ret2 = stack_array_search(42, my_stack2);
  ...
  // Push reverse
  ret1 = stack_array_push(100, my_stack1);
  printf("Reverse + Push 100 (1) 4 [0] : %d\n", ret1);
  if (ret1 == 0)
    printf("OK\n");
  else
    printf("!!! ERROR !!!\n");
  ret2 = stack_array_push(200, my_stack2);
  ...
  stack_array_push(5, my_stack1);
  stack_array_push(42, my_stack1);
  stack_array_push(100, my_stack1);
