...
void main_regular_tests(void)
{
  ...
  queue_ll_dequeue(my_queue2);
  queue_ll_dequeue(my_queue2);
  queue_ll_enqueue(2, my_queue2);
  queue_ll_enqueue(4, my_queue2);
  queue_ll_enqueue(8, my_queue2);
  queue_ll_enqueue(16, my_queue2);
  ...
  // Insert +
  ret1 = queue_ll_insert(42, 1, my_queue1);
  ...
  ret2 = queue_ll_insert(42, 1, my_queue2);
  ...
  // Insert -
  ret1 = queue_ll_insert(1337, -1, my_queue1);
  ...
  ret2 = queue_ll_insert(1337, -1, my_queue2);
  ...
  queue_ll_dequeue(my_queue1);
  queue_ll_dequeue(my_queue2);

  // Insert ++
  ret1 = queue_ll_insert(666, 100, my_queue1);
  ...
  ret2 = queue_ll_insert(666, 100, my_queue2);
  ...
  // Replace +
  ret1 = queue_ll_replace(999, 1, my_queue1);
  ...
  printf("Tail (1) 5 [666] : %d\n", ret1);
  test_output(ret1, 666);
  ret2 = queue_ll_replace(999, 1, my_queue2);
  ...
  queue_ll_replace(42, 1, my_queue1);
  queue_ll_replace(42, 1, my_queue2);

  ret1 = queue_ll_replace(999, 0, my_queue1);
  ...
  printf("Tail (1) 5 [666] : %d\n", ret1);
  test_output(ret1, 666);
  ret2 = queue_ll_replace(999, 0, my_queue2);
  ...
  queue_ll_replace(10, 0, my_queue1);
  queue_ll_replace(4, 0, my_queue2);

  ret1 = queue_ll_replace(999, 4, my_queue1);
  ...
  test_output(ret1, 999);
  ret2 = queue_ll_replace(999, 4, my_queue2);
  ...
  queue_ll_replace(666, 4, my_queue1);
  queue_ll_replace(666, 4, my_queue2);
  ...
  // Replace ++
  ret1 = queue_ll_replace(1024, 6, my_queue1);
  ...
  ret2 = queue_ll_replace(1024, 6, my_queue2);
  ...
  // Replace -
  ret1 = queue_ll_replace(2048, -6, my_queue1);
  ...
  ret2 = queue_ll_replace(2048, -6, my_queue2);
  ...
  // Enqueue reverse
  ret1 = queue_ll_enqueue(100, my_queue1);
  printf("Reverse + Enqueue 100 (1) 6 [0] : %d\n", ret1);
  test_output(ret1, 0);
  ret2 = queue_ll_enqueue(200, my_queue2);
  ...
  // Delete
  queue_ll_enqueue(5, my_queue1);
  queue_ll_enqueue(42, my_queue1);
  queue_ll_enqueue(100, my_queue1);
